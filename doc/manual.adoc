...
properties using the light inspector, which is accessed with the *L* key while a
light is selected.
...
*Texture*:: The falloff texture governs the shape of the lit area when rendered
