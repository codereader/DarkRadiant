...
compiler built into the game itself. For the Dark Mod, you would need to enter
the in-game console and type `dmap <mapname>`, where _<mapname>_ is the actual
filename of your map.
