...
separate floating windows which always appear above the main DarkRadiant window.
The main window itself is empty apart from the toolbars and status bar. Until
the introduction of the *Dockable* layout this was the most flexible, but the
multiple subwindows may be cumbersome to manage.
