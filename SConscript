...
archivezip_lst = build_list('plugins/archivezip', 'plugin.cpp pkzip.cpp zlibstream.cpp ZipArchive.cpp')
...
mapdoom3_lst=build_list('plugins/mapdoom3', 'NodeExporter.cpp Doom3MapFormat.cpp mapdoom3.cpp parse.cpp InfoFile.cpp')
...
if radiant_env['PLATFORM'] == 'win32':
    radiant_env.Install(INSTALL, 
       ['#w32deps/libxml2_mingw/lib/libxml2.dll', 
		...
		'#w32deps/gtk2/bin/intl.dll',
		'#w32deps/gtk2/bin/jpeg62.dll',
		'#w32deps/gtk2/bin/libatk-1.0-0.dll',
		'#w32deps/gtk2/bin/libcairo-2.dll',
		'#w32deps/gtk2/bin/libfontconfig-1.dll',
		'#w32deps/gtk2/bin/libgdk_pixbuf-2.0-0.dll',
		'#w32deps/gtk2/bin/libgdk-win32-2.0-0.dll',
		'#w32deps/gtk2/bin/libglib-2.0-0.dll',
		'#w32deps/gtk2/bin/libgmodule-2.0-0.dll',
		'#w32deps/gtk2/bin/libgobject-2.0-0.dll',
		...
		'#w32deps/boost/lib/boost_filesystem-mgw34-1_34.dll'])
