...
[Setup]
AppName=DarkRadiant
AppVerName=DarkRadiant 0.10.0pre1 x64
...
DefaultGroupName=DarkRadiant 0.10.0pre1 x64
OutputDir=C:\Games\DarkRadiant\tools\innosetup
OutputBaseFilename=darkradiant-0.10.0pre1.x64
Compression=lzma
...
Source: "C:\Games\DarkRadiant_install.x64\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
