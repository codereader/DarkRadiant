...
[Setup]
AppName=DarkRadiant
AppVerName=DarkRadiant 2.5.0pre1 x86
...
DefaultGroupName=DarkRadiant 2.5.0pre1 x86
OutputDir=.
OutputBaseFilename=darkradiant-2.5.0pre1-x86
Compression=lzma
...
Source: "C:\Program Files (x86)\Microsoft Visual Studio\2017\Enterprise\VC\Redist\MSVC\14.11.25325\x86\Microsoft.VC141.CRT\msvcp140.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Program Files (x86)\Microsoft Visual Studio\2017\Enterprise\VC\Redist\MSVC\14.11.25325\x86\Microsoft.VC141.CRT\vcruntime140.dll"; DestDir: "{app}"; Flags: ignoreversion
