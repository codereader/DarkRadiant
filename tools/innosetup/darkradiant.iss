...
[Setup]
AppName=DarkRadiant
AppVerName=DarkRadiant 0.9.9pre3 x64
...
DefaultDirName={pf64}\DarkRadiant
DefaultGroupName=DarkRadiant 0.9.9.pre3 x64
OutputDir=C:\Games\DarkRadiant\tools\innosetup
OutputBaseFilename=darkradiant-0.9.9pre3.x64
Compression=lzma
