...
void BrushModuleClass::constructPreferences(PreferencesPage& page) {
...
void BrushModuleClass::registerPreferencesPage() {
	// Instantiate a callback using <this> class and pass it to the preference system
