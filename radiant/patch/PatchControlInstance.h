 ...
 * 
 * The ObservedSelectable is then passing itself to the PatchInstance and from there further on to the SelectionSystem,
...
public:
	...
	// The observer/callback usually points back to the PatchInstance::selectedChangeComponent member method
